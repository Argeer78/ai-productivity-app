...
export default function TermsPage() {
  // ✅ Use root t and build full keys so we match DB keys like "terms.title"
  const { t: rawT } = useT("");
  const t = (key: string, fallback: string) => rawT(`terms.${key}`, fallback);
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 md:py-12 text-sm">
          <header className="mb-6">
            ...
            <p className="text-xs md:text-sm text-[var(--text-muted)]">
              {t("lastUpdatedLabel", "Last updated")}: {lastUpdated}
            </p>
          </header>
          ...
          <section className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 sm:px-5 py-5 text-[13px] leading-relaxed text-[var(--text-main)] space-y-4">
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section1.title", "1. Service description")}
            </h2>
            <p>
              {t(
                "section1.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section2.title", "2. No guarantees")}
            </h2>
            <p>
              {t(
                "section2.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section3.title", "3. Your account")}
            </h2>
            <p>
              {t(
                "section3.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section4.title", "4. Acceptable use")}
            </h2>
            <p>
              {t(
                "section4.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section5.title", "5. AI-generated content")}
            </h2>
            <p>
              {t(
                "section5.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section6.title", "6. Paid plans & billing")}
            </h2>
            <p>
              {t(
                "section6.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section7.title", "7. Changes to the service")}
            </h2>
            <p>
              {t(
                "section7.body",
            ...
            <h2 className="text-sm font-semibold mt-4">
              {t("section8.title", "8. Limitation of liability")}
            </h2>
            <p>
              {t(
                "section8.body",
