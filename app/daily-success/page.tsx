...
3. Gently point out 1–2 areas to improve without shaming.
4. Suggest 3 very specific adjustments they can try tomorrow (habits, planning, or environment).
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      ...
      <div className="flex-1">
        <div className="max-w-4xl mx-auto px-4 py-8 md:py-10 text-sm">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
            <div>
              ...
              <p className="text-xs md:text-sm text-slate-400">
                Start your day with a focused plan and end it with a clear
                reflection. The AI assistant does the heavy lifting.
              </p>
            </div>
            <Link
              href="/dashboard"
            ...
            <div className="mb-5 rounded-2xl border border-indigo-500/70 bg-indigo-900/20 px-4 py-3 text-[11px] text-indigo-100">
              ...
              <p className="mb-2">
                ...
                <span className="font-semibold">
                  Pro unlocks more AI usage and future automation
                </span>{" "}
          ...
          {/* Main grid: Morning / Focus / Evening */}
          ...
          <p className="mt-6 text-[11px] text-slate-500">
            Your answers are processed by the AI assistant. You can always
            fine-tune the output directly in the assistant panel.
          </p>
        </div>
      </div>
    </main>
