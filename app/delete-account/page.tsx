      ...
      <div className="flex-1">
        <div className="max-w-3xl mx-auto px-4 py-10 text-sm leading-relaxed text-slate-200">
          ...
          <p className="mb-4">
            ...
            (notes, tasks, planner entries, trips, daily scores, weekly reports,
            and settings), you can do so using one of the methods below.
          </p>
          ...
          <p className="mb-4">
            ...
            confirm deletion. Once confirmed, your account and all associated
          ...
          <p className="text-indigo-400 text-lg font-mono mb-4">
            hi@aiprod.app
          </p>

          <p className="mb-4">
            Please include the email address associated with your account and
            clearly state that you want your account deleted. We will process your
            request and delete your data within 48 hours.
          </p>
