      ...
      <div className="flex-1">
        <div className="max-w-3xl mx-auto px-4 py-8 md:py-12 leading-relaxed text-sm">
          ...
          <section className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 sm:px-5 py-5 text-[13px] leading-relaxed text-[var(--text-main)]">
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">3. Data Sharing</h2>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
              <li>
                <strong>Supabase</strong> – authentication, database and secure data
                storage
              </li>
              <li>
              ...
              <li>
                <strong>Plausible Analytics</strong> – privacy-friendly, anonymous
                analytics
              </li>
              <li>
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">5. Security</h2>
            <p className="mb-4">
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">6. Your Rights</h2>
            <p className="mb-4">
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">7. Contact</h2>
            <p className="mb-4">
