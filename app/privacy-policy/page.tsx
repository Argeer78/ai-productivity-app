...
export default function PrivacyPolicyPage() {
  // ✅ Use root t and build full keys so we match DB keys like "privacy.title"
  const { t: rawT } = useT("");
  const t = (key: string, fallback: string) => rawT(`privacy.${key}`, fallback);
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 md:py-12 leading-relaxed text-sm">
          ...
          <section className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] px-4 sm:px-5 py-5 text-[13px] leading-relaxed text-[var(--text-main)]">
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">
              {t("section1.title", "1. Information We Collect")}
            </h2>

            <p className="mb-2 font-semibold">
              {t("section1.1.title", "1.1 Account Information")}
            </p>
            <p className="mb-4">
              {t(
                "section1.1.body",
            ...
            <p className="mb-2 font-semibold">
              {t("section1.2.title", "1.2 User-Generated Content")}
            </p>
            <p className="mb-4">
              {t(
                "section1.2.body",
            ...
            <p className="mb-2 font-semibold">
              {t("section1.3.title", "1.3 Usage & Technical Data")}
            </p>
            <p className="mb-4">
              {t(
                "section1.3.body",
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">
              {t("section2.title", "2. How We Use Your Information")}
            </h2>
            <p className="mb-2">
              {t("section2.intro", "We use your data to:")}
            </p>
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">
              {t("section3.title", "3. Data Sharing")}
            </h2>
            <p className="mb-4">
              {t(
                "section3.body",
            ...
            <ul className="list-disc pl-5 mb-4 space-y-1">
              ...
              <li>
                ...
                {t(
                  "section3.item3.suffix",
                  "– privacy-friendly, anonymous analytics"
                )}
              </li>
              <li>
                <strong>{t("section3.item4.label", "AI provider")}</strong>{" "}
                {t(
                  "section3.item4.suffix",
            ...
            <h2 className="text-sm font-semibold mt-6 mb-2">
              {t("section4.title", "4. Data Retention")}
            </h2>
            <p className="mb-4">
              {t(
                "section4.body",
