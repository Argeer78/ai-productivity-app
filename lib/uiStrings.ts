...
export const UI_STRINGS = {
  ...
  "weeklyReports.subtitle": "AI-powered analysis of your week.",
  ...
  "travel.subtitle": "Plan trips with AI-generated itineraries.",

  // ===============================
  // MY TRIPS
  // ===============================
  "myTrips.title": "My Trips",
  "myTrips.subtitle": "View and manage saved trips.",
  ...
  // ===============================
  // TOOLS PAGE — HEADER & GENERIC LABELS
  // ===============================
  ...
  "tools.dashboard.bestFor1":
    "Starting your day with a quick overview",
  "tools.dashboard.bestFor2":
  ...
  // ===============================
  // TOOLS PAGE — AI HUB CHAT
  // ===============================
  "tools.chat.name": "AI Hub Chat",
  "tools.chat.shortTagline":
    "Your general-purpose AI assistant inside the workspace.",
  "tools.chat.description":
  ...
  "tools.chat.cta": "Open AI Hub Chat",

  // ===============================
  // TOOLS PAGE — NOTES
  // ===============================
  "tools.notes.name": "Notes & AI workspace",
  "tools.notes.shortTagline":
    "Capture ideas, journal, and let AI clean things up.",
  "tools.notes.description":
  ...
  "tools.notes.cta": "Go to Notes",

  // ===============================
  // TOOLS PAGE — TASKS
  // ===============================
  "tools.tasks.name": "Tasks & reminders",
  "tools.tasks.shortTagline":
    "Simple but powerful task list with reminders.",
  "tools.tasks.description":
  ...
  "tools.tasks.cta": "Open Tasks",

  // ===============================
  // TOOLS PAGE — AI TASK CREATOR
  // ===============================
  "tools.aiTaskCreator.name": "AI Task Creator",
  "tools.aiTaskCreator.shortTagline":
    "Turn vague goals into small, clear steps.",
  "tools.aiTaskCreator.description":
  ...
  "tools.dailySuccess.cta": "Update Daily Success",

  // ===============================
  // TOOLS PAGE — WEEKLY HISTORY
  // ===============================
  "tools.weeklyHistory.name": "Weekly AI reports & history",
  "tools.weeklyHistory.shortTagline":
    "See how your weeks are going over time.",
  "tools.weeklyHistory.description":
